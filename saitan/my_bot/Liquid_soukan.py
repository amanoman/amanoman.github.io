...
if __name__ == "__main__":
    ...
    parser.add_argument("year", type=int, help=u"年",
                        nargs="?", default=int(now.strftime("%Y")))
    parser.add_argument("month", type=int, help=u"月",
                        nargs="?", default=int(now.strftime("%m")))
    parser.add_argument("day", type=int, help=u"日",
                        nargs="?", default=int(now.strftime("%d")))
    ...
    ax.scatter(past_returns, future_returns, c="blue",
               s=20, edgecolors="blue", alpha=0.3)
    ...
    ax.grid(which="major", axis="x", color="gray",
            alpha=0.5, linestyle="dotted", linewidth=1)
